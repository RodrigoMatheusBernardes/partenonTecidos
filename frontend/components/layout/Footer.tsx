    ...
    <footer className="bg-primary-dark border-t border-white/20 text-white">
      ...
      <div className="border-y border-white/20 py-5 md:py-8">
        <div className="main-container flex flex-col items-center justify-center text-center gap-3 md:gap-6">
          ...
          <p className="font-secondary text-lg md:text-2xl leading-snug text-white/80 max-w-4xl mx-auto">
          ...
          <div className="w-full max-w-xl md:max-w-2xl relative mt-1">
            <input
              ...
              className="w-full border-2 border-white/30 rounded-full px-4 py-3 md:px-8 md:py-4 text-base md:text-lg font-secondary text-white placeholder:text-white/60 bg-white/10 focus:outline-none focus:border-gold transition-colors pr-14 md:pr-16"
            />
            <button
          ...
          <div>
            ...
            <div className="mt-5 pt-4 md:mt-6 md:pt-5 border-t border-white/20">
              ...
              <div className="flex gap-3">
                <a href="#" target="_blank" rel="noopener noreferrer" className="w-9 h-9 md:w-10 md:h-10 rounded-full border border-white/30 flex items-center justify-center hover:border-gold hover:text-gold transition-all duration-300 hover:scale-110 text-white">
