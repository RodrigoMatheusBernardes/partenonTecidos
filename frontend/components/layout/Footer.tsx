...
export default function Footer() {
  return (
    <footer className="bg-[#0B1F33] mt-24 border-t border-white/5">
      ...
      {/* COLUNAS */}
      <div className="max-w-7xl mx-auto px-6 mt-24 md:mt-32 pb-20 md:pb-28">
      ...
      {/* REDES SOCIAIS */}
      <div className="border-t border-white/10 mt-24 md:mt-32">
      ...
      {/* COPYRIGHT */}
      <div className="border-t border-white/10 mt-16 md:mt-24 bg-[#050A14]">
