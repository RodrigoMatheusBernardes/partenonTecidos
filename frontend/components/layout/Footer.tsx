  ...
  return (
    <footer className="bg-primary-dark border-t border-white/20 text-white">
      ...
      <div className="border-y border-white/20 py-4 md:py-8">
        <div className="footer-container flex flex-col items-center justify-center text-center gap-3 md:gap-6">
      ...
      {/* COLUNAS */}
      <div className="footer-container py-3 md:py-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-5 md:gap-4 font-secondary text-sm text-white/80">
      ...
      <div className="border-t border-white/20 bg-primary-dark/90">
        <div className="footer-container py-2 md:py-5 flex flex-col md:flex-row items-center justify-between gap-2 font-secondary text-xs text-white/80">
          <p>
