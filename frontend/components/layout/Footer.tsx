...
export default function Footer() {
  return (
    <footer className="bg-primary-dark border-t border-secondary-gray/20">
      
      {/* NEWSLETTER */}
      <div className="border-y border-secondary-gray/20 py-12 md:py-16">
        <div className="main-container flex flex-col md:flex-row items-center justify-between gap-8 md:gap-16">
          <div className="text-center md:text-left">
            <h2
              className="font-primary font-bold text-2xl md:text-3xl tracking-wide text-white"
            >
              Novidades e Promoções
            </h2>
            <p className="font-secondary text-sm mt-1 text-secondary-gray">
          ...
          <div className="w-full md:w-auto flex-1 max-w-md relative">
            <input
              ...
              className="w-full border border-secondary-gray/30 rounded-full px-6 py-4 text-sm font-secondary text-white placeholder:text-secondary-gray/50 bg-white/10 focus:outline-none focus:border-gold transition-colors pr-14"
            />
            <button
              className="absolute right-2 top-1/2 -translate-y-1/2 bg-gold text-primary-dark p-2 rounded-full hover:bg-gold-light transition-colors"
      ...
      <div className="main-container py-16 md:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16">
          ...
          <div>
            ...
            <ul className="space-y-4 font-secondary text-sm font-light text-secondary-gray">
          ...
          <div>
            ...
            <div className="mt-6 pt-6 border-t border-secondary-gray/20">
              <span className="font-primary text-xs font-bold uppercase tracking-widest block mb-4 text-white">
                Siga-nos
              </span>
              <div className="flex gap-4">
                <a href="#" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-secondary-gray/30 flex items-center justify-center hover:border-gold hover:text-gold transition-all duration-300 hover:scale-110 text-secondary-gray">
      ...
      {/* COPYRIGHT */}
      <div className="border-t border-secondary-gray/20 bg-primary-dark/90">
        <div className="main-container py-6 md:py-8 flex flex-col md:flex-row items-center justify-between gap-4 font-secondary text-xs font-light text-secondary-gray">
          <p>
          ...
          <div className="flex items-center gap-6">
            ...
            <span className="text-secondary-gray/30">|</span>
