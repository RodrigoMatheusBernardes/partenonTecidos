...
export default function Footer() {
  return (
    <footer className="bg-[#0B1F33] mt-24 md:mt-32 border-t border-white/5">
      ...
      {/* ================================================================
          CAMADA 1 – NEWSLETTER (com espaçamento generoso e bordas sutis)
          ================================================================ */}
        ...
        <div className="main-container flex flex-col md:flex-row items-center justify-between gap-8 md:gap-16">
          ...
          <div className="w-full md:w-auto flex-1 max-w-lg relative">
            <input
              ...
              className="w-full border border-white/20 rounded-sm px-6 py-4 text-sm !text-white placeholder:text-white/40 bg-white/10 focus:outline-none focus:border-[#C5A880] transition-colors"
            />
            <Mail className="absolute right-5 top-1/2 -translate-y-1/2 w-5 h-5 text-white/40" strokeWidth={1.5} />
          </div>
        </div>
      </div>

      {/* ================================================================
          CAMADA 2 – COLUNAS DE NAVEGAÇÃO (Grande espaçamento vertical)
          ================================================================ */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-16 md:gap-20 lg:gap-24">
          ...
          <div>
            <div className="flex items-center gap-6 mb-8">
              <h4 className="font-serif font-light text-lg !text-white tracking-wider">Institucional</h4>
              <div className="flex-1 h-px bg-white/10"></div>
            </div>
            <ul className="space-y-5 text-sm !text-white/80 font-light">
              <li className="flex items-center gap-3 hover:text-[#C5A880] transition-colors duration-300">
          ...
          <div>
            <div className="flex items-center gap-6 mb-8">
              <h4 className="font-serif font-light text-lg !text-white tracking-wider">Informações</h4>
              <div className="flex-1 h-px bg-white/10"></div>
            </div>
            <ul className="space-y-5 text-sm !text-white/80 font-light">
              <li className="flex items-center gap-3 hover:text-[#C5A880] transition-colors duration-300">
          ...
          <div>
            <div className="flex items-center gap-6 mb-8">
              <h4 className="font-serif font-light text-lg !text-white tracking-wider">Minha Conta</h4>
              <div className="flex-1 h-px bg-white/10"></div>
            </div>
            <ul className="space-y-5 text-sm !text-white/80 font-light">
              <li className="flex items-center gap-3 hover:text-[#C5A880] transition-colors duration-300">
          ...
          <div>
            <div className="flex items-center gap-6 mb-8">
              <h4 className="font-serif font-light text-lg !text-white tracking-wider">Contato</h4>
              <div className="flex-1 h-px bg-white/10"></div>
            </div>
            <ul className="space-y-5 text-sm !text-white/80 font-light">
              <li className="flex items-start gap-3 hover:text-[#C5A880] transition-colors duration-300">
      ...
      {/* ================================================================
          CAMADA 3 – REDES SOCIAIS (Espaçamento generoso e linha divisória)
          ================================================================ */}
      <div className="border-t border-white/10 mt-32 md:mt-40">
        <div className="main-container py-16 md:py-20">
          <div className="flex flex-wrap items-center justify-between gap-6">
            <span className="text-xs font-medium uppercase tracking-widest !text-white/60 block">Siga-nos</span>
            <div className="flex items-center gap-4">
              <a href="#" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-white/20 !text-white/60 flex items-center justify-center hover:border-[#C5A880] hover:!text-[#C5A880] transition-colors duration-300">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
              </a>
              <a href="#" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full border border-white/20 !text-white/60 flex items-center justify-center hover:border-[#C5A880] hover:!text-[#C5A880]">
      ...
      {/* ================================================================
          CAMADA 4 – COPYRIGHT (Base sólida, destacada por um gap e borda)
          ================================================================ */}
