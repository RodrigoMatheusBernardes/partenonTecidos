...
export default function Footer() {
  return (
    <footer className="bg-[#0B1F33] mt-24 border-t border-white/5">
      ...
      {/* ================================================================
          CAMADA 2 – COLUNAS DE NAVEGAÇÃO (LETRAS BRANCAS E NÍTIDAS)
          ================================================================ */}
      ...
      {/* ================================================================
          CAMADA 3 – RODAPÉ (COPYRIGHT + REDES SOCIAIS + POLÍTICAS)
          ================================================================ */}
      <div className="border-t border-white/10 mt-8">
        <div className="max-w-7xl mx-auto px-6 py-8 md:py-10 flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-white/60">
          ...
          {/* Centro – Ícones das Redes Sociais (Em círculos com borda) */}
          <div className="flex items-center gap-4">
            {/* X (Twitter) */}
            <a href="#" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center text-white/70 hover:border-[#C5A880] hover:text-[#C5A880] transition-all duration-300">
