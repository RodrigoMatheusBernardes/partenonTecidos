...
export default function Footer() {
  return (
    <footer className="bg-[#0B1F33] mt-24">
      
      {/* NEWSLETTER (SEM borda superior, apenas espaçamento) */}
      ...
      {/* COLUNAS DE NAVEGAÇÃO – com barra superior e espaçamento */}
      <div className="max-w-7xl mx-auto px-6 mt-16 md:mt-20 border-t border-white/10 pt-8 md:pt-12 pb-20 md:pb-28">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 md:gap-20 lg:gap-24">
          ...
          {/* Coluna 2 – Suporte */}
          <div>
            <h4 className="text-[10px] font-medium uppercase tracking-[0.15em] !text-white mb-8">
              Suporte
            </h4>
        ...
        <div className="max-w-7xl mx-auto px-6 py-12 md:py-16">
          <div className="flex flex-wrap items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-4">
              {/* X */}
              <a href="#" target="_blank" rel="noopener" className="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center !text-white hover:border-[#C5A880] hover:text-[#C5A880] transition-all duration-300">
      ...
      {/* COPYRIGHT */}
      <div className="border-t border-white/10 mt-16 md:mt-20 bg-[#050A14]">
        <div className="max-w-7xl mx-auto px-6 py-8 md:py-10 flex flex-col md:flex-row items-center justify-between gap-6 text-xs !text-white">
