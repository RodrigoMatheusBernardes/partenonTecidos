  ...
  return (
    <footer className="bg-[#1A2D44] border-t border-white/5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16">
          ...
          <div>
            ...
            <div className="mt-6 pt-6 border-t border-white/10">
              <span className="text-xs font-medium uppercase tracking-widest text-white/70 block mb-4">
                Siga-nos
              </span>
              <div className="flex gap-4">
                <a href="#" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white/90 hover:border-gold hover:text-gold transition-all duration-300 hover:scale-110">
      ...
      <div className="border-t border-white/10 bg-[#0F1A2B]">
        <div className="main-container py-6 md:py-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-white/80 font-light">
