  ...
  return (
    <footer className="bg-primary-dark border-t border-white/20 text-white">
      ...
      <div className="border-y border-white/20 py-8 md:py-16">
        <div className="main-container flex flex-col items-center justify-center text-center gap-6 md:gap-10">
          ...
          <div className="flex justify-center mt-1">
            <Link
              href="/cadastro"
              className="inline-block border-2 border-transparent bg-gradient-to-r from-[#0A1420] via-[#1A3A5C] to-[#0A1420] bg-[length:200%_100%] text-white !text-white px-6 py-3 md:px-12 md:py-4 rounded-full text-base md:text-lg font-secondary font-bold transition-all duration-500 hover:bg-[length:100%_100%] hover:shadow-lg hover:scale-105"
            >
              Criar sua conta
            </Link>
          </div>
      ...
      <div className="main-container py-12 md:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 md:space-y-3 font-secondary text-sm text-white/80">
          ...
          <div>
            ...
            <div className="mt-6 pt-5 border-t border-white/20">
              ...
              <div className="flex gap-3">
                ...
                <a href="#" target="_blank" rel="noopener noreferrer" className="w-8 h-8 md:w-10 md:h-10 rounded-full border border-white/30 flex items-center justify-center hover:border-gold hover:text-gold transition-all duration-300 hover:scale-110 text-white">
                  <svg className="w-4 h-4 md:w-5 md:h-5 fill-current" viewBox="0 0 24 24"><path d="M12.02 22c-.847 0-1.67-.114-2.452-.332l-4.62 1.635 1.572-4.627A9.93 9.93 0 0 1 2 12.02C2 6.496 6.476 2 12.02 2S22 6.496 22 12.02 17.524 22 12.02 22z"/></svg>
                </a>
                <a href="#" target="_blank" rel="noopener noreferrer" className="w-8 h-8 md:w-10 md:h-10 rounded-full border border-white/30 flex items-center justify-center hover:border-gold hover:text-gold transition-all duration-300 hover:scale-110 text-white">
      ...
      <div className="border-t border-white/20 bg-primary-dark/90">
        <div className="main-container py-5 md:py-6 flex flex-col md:flex-row items-center justify-between gap-3 font-secondary text-xs text-white/80">
          <p>
