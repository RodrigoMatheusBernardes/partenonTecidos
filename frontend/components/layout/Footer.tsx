    ...
    <footer className="bg-primary-dark border-t border-white/20 text-white">
      ...
      <div className="border-y border-white/20 py-12 md:py-16">
        <div className="main-container flex flex-col md:flex-row items-center justify-between gap-8 md:gap-16">
          <div className="text-center md:text-left">
            <h2 className="font-primary font-bold text-2xl md:text-3xl tracking-wide">
          ...
          <div className="w-full md:w-auto flex-1 max-w-md relative">
            <input
              ...
              className="w-full border border-white/30 rounded-full px-6 py-4 text-sm font-secondary placeholder:text-white/50 bg-white/10 focus:outline-none focus:border-gold transition-colors pr-14"
            />
            <button
      ...
      <div className="main-container py-16 md:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16">
          ...
          <div>
            <h4 className="font-primary font-bold text-lg mb-6 tracking-wide">
              Institucional
            </h4>
          ...
          <div>
            ...
            <div className="mt-6 pt-6 border-t border-white/20">
              <span className="font-primary text-xs font-bold uppercase tracking-widest block mb-4">
                Siga-nos
              </span>
              <div className="flex gap-4">
                <a href="#" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center hover:border-gold hover:text-gold transition-all duration-300 hover:scale-110">
