  ...
  return (
    <footer className="bg-[#0B1F33] border-t border-white/5">
        ...
        <div className="main-container flex flex-col md:flex-row items-center justify-between gap-8 md:gap-16">
          ...
          <div className="w-full md:w-auto flex-1 max-w-md relative">
            <input
              ...
              className="w-full border border-white/20 rounded-full px-6 py-4 text-sm text-white placeholder:text-white/40 bg-white/10 focus:outline-none focus:border-gold transition-colors pr-14"
            />
            <button
          ...
          <div>
            ...
            <div className="mt-6 pt-6 border-t border-white/10">
              ...
              <div className="flex gap-4">
                <a href="#" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white/60 hover:border-gold hover:text-gold transition-all duration-300 hover:scale-110">
      ...
      <div className="border-t border-white/10 bg-[#050A14]">
        <div className="main-container py-6 md:py-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-white/50 font-light">
