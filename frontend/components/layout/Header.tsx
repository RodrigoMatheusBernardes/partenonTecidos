        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-6">
            <button
              ...
              className="text-white hover:text-[#C5A880] transition-colors"
            >
            ...
            <Link
              href="/favoritos"
              className="text-white hover:text-[#C5A880] transition-colors hidden sm:block"
            >
            ...
            <button
              ...
              className="text-white hover:text-[#C5A880] transition-colors relative"
            >
            ...
            <button
              ...
              className="md:hidden text-white hover:text-[#C5A880] transition-colors"
            >
