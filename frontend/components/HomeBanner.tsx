    ...
    <section className="relative w-full h-[85vh] min-h-[500px] overflow-hidden bg-zinc-900 group">
      ...
      <div className="relative z-30 flex items-center justify-center h-full px-6">
        <div className="text-center max-w-2xl space-y-6 drop-shadow-[0_4px_6px_rgba(0,0,0,0.7)]">
          <p className="text-xs md:text-sm tracking-[0.3em] uppercase font-light font-sans text-white">
            Nova Coleção 2026
          </p>
          <h1 className="text-4xl md:text-7xl lg:text-8xl font-light tracking-[0.1em] leading-tight font-serif text-white">
            Parthenon <br />
            <span className="font-bold tracking-tighter text-white">Tecidos</span>
          </h1>
          <p className="text-sm md:text-base tracking-[0.2em] font-light uppercase font-sans text-white">
