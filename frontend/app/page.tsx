      ...
      <div className="w-full max-w-[1440px] mx-auto px-6 pb-6 md:pb-8">
        <div className="flex gap-8 lg:gap-12 pt-4 md:pt-5">
          ...
          <div className="flex-1 min-w-0">
            ...
            {/* ============================================================ */}
            {/* NÍVEL 2 – CONTROLES (quantidade à esquerda, select à direita) */}
            {/* ============================================================ */}
            ...
            {/* ============================================================ */}
            {carregando ? (
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-8 mt-6 md:mt-7">
              ...
              <div className="text-center py-20 bg-light rounded-card mt-6 md:mt-7">
