              ...
              <div className="grid md:grid-cols-2 gap-8 items-stretch">
                ...
                <div className="flex flex-col justify-center space-y-6 p-6 bg-white/85 backdrop-blur-sm rounded-card border border-white/30 shadow-lg-luxury">
                  <div className="flex items-start gap-4">
                    <MapPin className="w-6 h-6 text-white flex-shrink-0 mt-1" strokeWidth={1.5} />
                    <div>
                  ...
                  <div className="flex items-start gap-4">
                    <Phone className="w-6 h-6 text-white flex-shrink-0 mt-1" strokeWidth={1.5} />
                    <div>
                  ...
                  <div className="flex items-start gap-4">
                    <Mail className="w-6 h-6 text-white flex-shrink-0 mt-1" strokeWidth={1.5} />
                    <div>
...
<section className="py-16 md:py-24">
  <div className="main-container text-center max-w-3xl mx-auto">
    ...
    {/* REDES SOCIAIS COM FUNDO E ÍCONES BRANCOS */}
<div className="mt-10">
  <div className="inline-block bg-black/30 backdrop-blur-sm px-8 py-6 rounded-card border border-white/10">
    <p
    ...
    <div className="flex justify-center gap-6">
      <a href="#" target="_blank" rel="noopener noreferrer" className="hover:text-gold transition-colors duration-300">
