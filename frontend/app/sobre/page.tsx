        ...
        <div className="relative z-10">
          ...
          <section className="py-16 md:py-24">
            <div className="main-container">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-stretch">
                ...
                <div className="flex flex-col justify-center space-y-6 p-6 bg-white/80 backdrop-blur-sm rounded-card border border-white/30 shadow-lg-luxury">
          ...
          <section className="py-16 md:py-24">
            <div className="main-container text-center max-w-3xl mx-auto">
              ...
              <div className="mt-10">
                <p className="text-white/70 text-sm mb-4">Siga-nos nas redes sociais</p>
                <div className="flex justify-center gap-6">
                  <a href="#" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-gold transition-colors duration-300">
